...
if (!src.includes('controlled-buyer-gate-follow-up-decision.controller')) {
  const requireLine = 'const controlledBuyerGateFollowUpDecisionController = require("../controllers/controlled-buyer-gate-follow-up-decision.controller");\n';
...
const block = `  if (method === "GET" && url.pathname === "/api/controlled-buyer-gate-follow-up-decision/preview") {
...
if (!src.includes("controlledBuyerGateFollowUpDecisionController.previewController")) {
...
console.log("Version 38A controlled buyer-gate follow-up decision routes patched.");
